...
public class CancelOrderKafkaMessagePublisher implements OrderCancelledPaymentRequestMessagePublisher {
    ...
    public CancelOrderKafkaMessagePublisher(OrderMessagingDataMapper orderMessagingDataMapper,
                                            OrderServiceConfigData orderServiceConfigDataM,
                                            KafkaProducer<String, PaymentRequestAvroModel> kafkaProducer,
                                            OrderKafkaMessageHelper orderKafkaMessageHelper) {
        this.orderMessagingDataMapper = orderMessagingDataMapper;
        this.orderServiceConfigData = orderServiceConfigDataM;
    ...
    public void publish(OrderCancelledEvent domainEvent) {
        ...
        try {
            ...
            log.error("Error while sending PaymentRequestAvroModel message" + " to kafka with oder id: {}, error: {}", orderId, e.getMessage());
        }
